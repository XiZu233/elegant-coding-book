...
上一章我们搭好了开发环境，现在可以开始写真正的代码了。本章的目标是让你**看懂 Python 代码**，而不是背下所有语法。就像学外语时先学会"认字"和"读句子"，你不需要记住每个单词，但要能理解它在说什么。

> 选择第一门语言：Python。理由很简单——表达力最强，AI训练数据最多。不要纠结"最好"的语言，先让电脑听你的话。

本章分为三个层次：核心语法（能跑）、代码审美（好看）、以及为什么传统编程基础仍然重要。学完这一章，你就能读懂 AI 生成的代码，并判断它写得是否规范。

---

## 第一层：能跑（核心语法）

![Python 四要素思维导图](assets/images/02-python-four-elements.png)
...
![函数拆解乐高积木示意图](assets/images/02-function-lego.png)
...
![缩进对比示意图](assets/images/02-indent-compare.png)
...
![调试流程图](assets/images/02-debug-flow.png)
...
![错误信息解读示意图](assets/images/02-5-python-traceback.png)
...
现在你已经掌握了 Python 的核心语法和代码审美标准。但在实际编程中，你不需要手写每一行代码——第03章将带你进入 AI 编程工具的世界，学习如何让 Claude Code 和 Kimi Code 帮你生成、解释和优化代码。准备好从"自己写"进化到"指挥 AI 写"了吗？
